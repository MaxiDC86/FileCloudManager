...
class DocumentManagerApplicationTests {
	...
	void testInsertDocument() throws IOException {
		File file = new File("M:\\copia.png");
		...
		//---Insert document on the database-----
		Document savedDoc = repo.save(document);
		
		Document existDocument = entityManager.find(Document.class, savedDoc.getId());
